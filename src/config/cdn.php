...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Enable loading assets from the CDN
    |--------------------------------------------------------------------------
    |
    | This option determines whether to load the assets locally or from the CDN. Disabling the CDN
    | can be useful during development. Set it to "true" to load from localhost, or set it to "false" to load
    |
    | Default: true
    |
    */
    ...
    */
    ...
    |
    */
    'url' => env('CDN_URL', 'http://breachaware.test/'),
